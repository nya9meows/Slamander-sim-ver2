...
startPos = [0, 0, 0.1]
startPos2 = [0.25, 0, 0.1]
startOrientation = p.getQuaternionFromEuler([0, 0, 0])
# boxId = p.loadURDF("r2d2.urdf",startPos, startOrientation)
boxId = p.loadURDF("./3D_ver5/urdf/3D_ver5.urdf", startPos, startOrientation)
# boxId2 = p.loadURDF("./3D_ver5/urdf/3D_ver5.urdf", startPos2, startOrientation)
boxId2 = p.loadURDF("./segf_ver4/urdf/segf_ver4.urdf",startPos, startOrientation)

# parentbody parentlink-1forbase childbody-1forworldcoordinate childlinkindex-1forbase jointtype jointaxis
# parentframeposition chiledframeposition (optional)parentframeorientation (op)childframeorientation (op)physicsclientid
cid = p.createConstraint(boxId, -1, boxId2, 5, p.JOINT_FIXED, [0.0, 0.0, 0.0], [0.05, 0, 0], [-0.05, 0, 0], [0, 0, 0],
                         [0, 0, 0])
print(cid)
print(p.getConstraintUniqueId(0))
pivot = [0, 0, 0]
halfpi = math.pi / 2.0
orn = p.getQuaternionFromEuler([0, 0, halfpi])
